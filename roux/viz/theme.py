...
def set_theme(
    ...
    plt.rcParams["legend.labelspacing"]=0.1  # the vertical space between the legend entries
    #legend.handlelength:  2.0  # the length of the legend lines
    #legend.handleheight:  0.7  # the height of the legend handle
    plt.rcParams["legend.handletextpad"]=0  # the space between the legend line and legend text
