# AUTOGENERATED! DO NOT EDIT! File to edit: ../../examples/roux_stat_agg.ipynb.

# %% auto 0
__all__ = ['ArrayLike', 'agg_means', 'agg_vars', 'agg_stds', 'get_running_mean']

# %% ../../examples/roux_stat_agg.ipynb 1
import numpy as np
...
def get_running_mean(
    ...
    """Welford's numerically stable running mean."""
    count += 1
